...
public class SecondFragment extends BaseFragment {
    ...
    private void initTablayout() {
        ...
        //循环注入标签
        for (String tab: Contants.tabSecondTitleList){
    ...
    private void initViewPager() {
        ...
        fragments.clear();
        for (int i = 0; i < Contants.tabSecondTitleList.size(); i++) {
            SecondSubFragment secondSubFragment = new SecondSubFragment();
            Bundle bundle = new Bundle();
            bundle.putInt("position",i);
            secondSubFragment.setArguments(bundle);
            fragments.add(secondSubFragment);
        }

        TablayoutViewpagerAdapter viewPagerAdapter = new TablayoutViewpagerAdapter(getChildFragmentManager(),Contants.tabSecondTitleList,fragments);
